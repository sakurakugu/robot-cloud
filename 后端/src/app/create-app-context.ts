...
import { PostgresAccountRepository } from '../features/account/repository';
import { AccountService } from '../features/account/service';
import { KnowledgeController } from '../features/knowledge/controller';
import { PostgresKnowledgeRepository } from '../features/knowledge/repository';
import { KnowledgeService } from '../features/knowledge/service';
import { 反馈控制器 } from '../features/反馈/controller';
import { PostgresFeedbackRepository } from '../features/反馈/repository';
import { 反馈服务 } from '../features/反馈/service';
import { 对话服务 } from '../features/大模型交互/chat-service';
import { 对话控制器 } from '../features/大模型交互/controller';
import { PostgresConversationRepository } from '../features/大模型交互/repository';
import { 大模型管理控制器 } from '../features/大模型管理/controller';
import { 大模型配置服务 } from '../features/大模型管理/service';
import { 更新控制器 } from '../features/更新管理/controller';
import { PostgresAppVersionRepository } from '../features/更新管理/repository';
import { 更新服务 } from '../features/更新管理/service';
import { 机器人包控制器 } from '../features/机器人包管理/controller';
import { PostgresRobotPackageRepository } from '../features/机器人包管理/repository';
import { 机器人包服务 } from '../features/机器人包管理/service';
import { 机器人控制器 } from '../features/机器人管理/controller';
import { PostgresRobotRepository } from '../features/机器人管理/repository';
import { 机器人服务 } from '../features/机器人管理/service';
import { ChoreoController } from '../features/编舞系统/controller';
import { 创建编舞执行消息网关 } from '../features/编舞系统/execution-message-gateway';
import { ChoreoService } from '../features/编舞系统/service';
import { 角色控制器 } from '../features/角色管理/controller';
import { PostgresRoleRepository } from '../features/角色管理/repository';
import { 角色服务 } from '../features/角色管理/service';
import { 设置控制器 } from '../features/设置/controller';
import { PostgresSettingsRepository } from '../features/设置/repository';
import { 设置服务 } from '../features/设置/service';
import { 默认系统提示词 } from '../infra/const';
import { PostgreSQL数据库客户端 } from '../infra/db/client';
