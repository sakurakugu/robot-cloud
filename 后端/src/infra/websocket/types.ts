...
// 引用其他模块的类型
import type { TTSOptions } from '../../features/大模型交互/types';
import type { ActionCommand } from '../../features/机器人交互/types';
import type { ChoreoWSMessage } from '../../features/编舞系统/types';
